...
const ChooseUs = () => {
  return (
    <section className="section-space-top section-space-bottom-2 overflow-hidden">
                ...
                <div className="choose-us__content-wrapper mt-35">
                  ...
                  >
                    <div className="choose-us__content-wrapper-box-title">
                      ...
                      <h3 style={{ fontSize: "15px" }}> Diaspora Investment</h3>
                    </div>
                    <div className="choose-us__content-wrapper-box-list">
                      <ul>
                        <li>
                          <i className="fa-solid fa-check"></i>Beyond Border
                          Immigration
                        </li>
                        <li>
                          <i className="fa-solid fa-check"></i>Worldwide Visa
                          Assistance
                        </li>
                      </ul>
                    </div>
                  ...
                  >
                    ...
                    <div className="choose-us__content-wrapper-box-list">
                      <ul>
                        <li>
                          <i className="fa-solid fa-check"></i>GlobeTrot Visa
                          Services
                        </li>
                        <li>
                          <i className="fa-solid fa-check"></i>Infinity Visa
                          Solutions
                        </li>
                      </ul>
                    </div>
