...
const Testimonial = () => {
  return (
    <section className="testimonial__area section-space-bottom gray-bg">
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-7">
            <div className="testimonial__media" data-tilt>
              <img src="/assets/imgs/testimonial/testimonial2-left-img.png" alt="img not found" className="height-693" />
            </div>
          </div>
          <div className="col-lg-5">
            <div className="testimonial__content testimonial__content-2 swiper wow fadeInLeft animated" data-wow-delay=".3s">
                  ...
                  <div className="testimonial__content-text testimonial__content-2-text">
                    ...
                    <div className="testimonial__content-text-title">
                      <div className="testimonial__content-text-title-img">
                        <img src="/assets/imgs/testimonial/testimonial2-title-img.png" alt="img not found" />
                      </div>
