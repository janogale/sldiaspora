        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="ask-question__media d-flex">
              <div className="ask-question__media-thumb">
                <div className="ask-question__media-thumb-img wow fadeInLeft animated" data-wow-delay=".2s">
                  <img src="/assets/imgs/ask-qustion/ask-qustion-left-img.png" alt="img not found" />
                </div>
                <div className="ask-question__text mt-30 wow fadeInLeft animated" data-wow-delay=".3s">
              ...
              <div className="ask-question__media-img">
                <div className="ask-question__media-img-img1 wow fadeInLeft animated" data-wow-delay=".4s">
                  <img src="/assets/imgs/ask-qustion/ask-qustion-right-top-img.png" alt="img not found" />
                </div>
                <div className="ask-question__media-img-img2 wow fadeInLeft animated" data-wow-delay=".5s">
                  <img src="/assets/imgs/ask-qustion/ask-qustion-right-bottom-img.png" alt="img not found" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="section__title-wrapper mb-40">
              <h6 className="section__title-wrapper-black-subtitle mb-10 wow fadeInLeft animated" data-wow-delay=".2s">Ask Question<svg width="52" height="10" viewBox="0 0 52 10" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <h2 className="section__title-wrapper-title wow fadeInLeft animated" data-wow-delay=".3s">Wanderlust Chronicles <br /> Tales from Around</h2>
            </div>
            <div className="ask-question__faq">
              <div className="accordion" id="accordionExample">
                <div className="accordion-item ask-question__faq-item wow fadeInLeft animated" data-wow-delay=".4s">
                  ...
                  <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div className="accordion-body">
                      <p>Lorem Ipsum is simply dummy text the printing and typese <br /> Lorem Ipsum has been the industry's standard dummy text ever</p>
                    </div>
                  </div>
                </div>

                <div className="accordion-item ask-question__faq-item wow fadeInLeft animated" data-wow-delay=".5s">
                ...
                <div className="accordion-item ask-question__faq-item wow fadeInLeft animated" data-wow-delay=".6s">
