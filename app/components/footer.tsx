        ...
        <div className="container">
          <div className="row mb-minus-40 footer-wrap">
            <div className="col-lg-4 col-md-6 col-sm-6">
              ...
              >
                ...
                <div className="footer__content">
                  <p>
                    Your direct line to ministries and services for investment,
                    citizenship, and national contribution.
                  </p>
                </div>
            ...
            <div className="col-lg-2 col-md-6 col-sm-6">
              <div
                className="footer__widget footer__widget-item-2 footer3__item-2 wow fadeInLeft animated"
                data-wow-delay=".3s"
              >
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div
                className="footer__widget footer__widget-item-3 wow fadeInLeft animated mt-md-50 mt-sm-40 mt-xs-35"
                data-wow-delay=".4s"
              >
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div
                className="footer__widget footer__widget-item-4 wow fadeInLeft animated mt-md-50 mt-sm-40 mt-xs-35"
                data-wow-delay=".5s"
              >
                <div className="footer__widget-title">
        ...
        <div className="footer__bottom-wrapper">
          <div className="container">
            <div className="footer__bottom">
              <div
                className="footer__copyright wow fadeInLeft animated"
                data-wow-delay=".6s"
              >
                <p>
                  © {new Date().getFullYear()} Somaliland Diaspora Portal. All
                  rights reserved.
                </p>
              </div>
