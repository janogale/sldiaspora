        ...
        <div className="container">
          <div className="row">
            <div className="section__title-wrapper text-center mb-60">
              <h6 className="section__title-wrapper-center-subtitle mb-10 wow fadeInLeft animated" data-wow-delay=".6s">
              ...
              <h2 className="section__title-wrapper-title wow fadeInLeft animated" data-wow-delay=".8s">Nature's Playground <br /> Exploring the Great  </h2>
            </div>
          </div>
          <div className="row mb-minus-30">
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
              <div className="coaching__item mb-30 d-flex align-items-center wow fadeInLeft animated" data-wow-delay=".2s">
                <div className="coaching__item-midea">
                  <img className="img-fluid" src="/assets/imgs/coaching/coaching-card-img1.png" alt="img not found" data-tilt />
                </div>
                <div className="coaching__item-content">
                  <h4 className="coaching__item-content-title mb-20">Dualugo Coaching</h4>
                  <p>There are many variati of passages of engineer</p>
                  <Link href="/coaching-details">Read More
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
              <div className="coaching__item mb-30 d-flex align-items-center wow fadeInLeft animated" data-wow-delay=".3s">
                <div className="coaching__item-midea">
                  <img className="img-fluid" src="/assets/imgs/coaching/coaching-card-img2.png" alt="img not found" data-tilt />
                </div>
                <div className="coaching__item-content">
                  <h4 className="coaching__item-content-title mb-20">IELTS Coaching</h4>
                  <p>There are many variati of passages of engineer</p>
                  <Link href="/coaching-details">Read More
                    <i className="fa-solid fa-arrow-right"></i>
                  </Link>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
              <div className="coaching__item mb-30 d-flex align-items-center wow fadeInLeft animated" data-wow-delay=".4s">
                <div className="coaching__item-midea">
                  <img className="img-fluid" src="/assets/imgs/coaching/coaching-card-img3.png" alt="img not found" data-tilt />
                </div>
                <div className="coaching__item-content">
                  <h4 className="coaching__item-content-title mb-20">TOFEL Coaching</h4>
                  <p>There are many variati of passages of engineer</p>
                  <Link href="/coaching-details">Read More
                    <i className="fa-solid fa-arrow-right"></i>
                  </Link>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
              <div className="coaching__item mb-30 d-flex align-items-center wow fadeInLeft animated" data-wow-delay=".5s">
                <div className="coaching__item-midea">
                  <img className="img-fluid" src="/assets/imgs/coaching/coaching-card-img4.png" alt="img not found" data-tilt />
                </div>
                <div className="coaching__item-content">
                  <h4 className="coaching__item-content-title mb-20">IELTS Listing</h4>
                  <p>There are many variati of passages of engineer</p>
                  <Link href="/coaching-details">Read More
                    <i className="fa-solid fa-arrow-right"></i>
                  </Link>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
              <div className="coaching__item mb-30 d-flex align-items-center wow fadeInLeft animated" data-wow-delay=".6s">
                <div className="coaching__item-midea">
                  <img className="img-fluid" src="/assets/imgs/coaching/coaching-card-img5.png" alt="img not found" data-tilt />
                </div>
                <div className="coaching__item-content">
                  <h4 className="coaching__item-content-title mb-20">OET Coaching</h4>
                  <p>There are many variati of passages of engineer</p>
                  <Link href="/coaching-details">Read More
                    <i className="fa-solid fa-arrow-right"></i>
                  </Link>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
              <div className="coaching__item mb-30 d-flex align-items-center wow fadeInLeft animated" data-wow-delay=".7s">
                <div className="coaching__item-midea">
                  <img className="img-fluid" src="/assets/imgs/coaching/coaching-card-img6.png" alt="img not found" data-tilt />
                </div>
                <div className="coaching__item-content">
                  <h4 className="coaching__item-content-title mb-20">Language Coahing</h4>
                  <p>There are many variati of passages of engineer</p>
                  <Link href="/coaching-details">Read More
                    <i className="fa-solid fa-arrow-right"></i>
                  </Link>
            ...
            <div className="coaching__bottom-btn">
              <Link href="/coaching" className="rr-btn">All Courses</Link>
            </div>
          </div>
        </div>
      </div>
